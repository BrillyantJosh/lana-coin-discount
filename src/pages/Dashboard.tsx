      ...
      <div className="flex-1 container mx-auto px-4 sm:px-6 py-6 sm:py-12">
        ...
        {isAdmin && (
          <div className="max-w-4xl mx-auto mt-8 text-center">
            <Link
              to="/admin"
              className="inline-flex items-center gap-2 rounded-lg bg-red-600 px-5 py-2.5 text-sm font-bold text-white uppercase tracking-wider hover:bg-red-700 transition-colors"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
